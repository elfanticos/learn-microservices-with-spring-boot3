...
class LeaderBoardComponent extends Component {
    ...
    getLeaderBoardData() {
        return GameApiClient.leaderBoard().then(leaderBoardData => {
            ...
            <div>
                ...
                <table>
                    ...
                    {this.state.leaderboard.map(row => <tr key={row.userId}>
                        ...
                        <td>{row.badges.map(b => <span className="badge" key={b}>{b}</span>)}
                        </td>
                    </tr>)}
                    </tbody>
                </table>
